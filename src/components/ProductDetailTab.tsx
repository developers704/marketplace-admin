...
const ProductDetailTabs = ({
    ...
    const VariantForm = ({
        ...
        const [imageAltTextChild, setImageAltTextChild] = useState('')
        ...
        const handleSaveVariant = async () => {
            ...
            formData.append('currency', parentProducts.currency || 'PKR');
            formData.append('isShopByPet', parentProducts.isShopByPet || 'false');
            formData.append('isServiceProduct', parentProducts.isServiceProduct || 'false');
            formData.append('isNewArrival', parentProducts.isNewArrival || 'false');
            ...
            if (parentProducts.brand) formData.append('brandId', parentProducts.brand);
            if (parentProducts.lifecycleStage) formData.append('lifecycleStage', parentProducts.lifecycleStage);
            if (parentProducts.variationId) formData.append('variationId', parentProducts.variationId);
            if (parentProducts.meta_title) formData.append('meta_title', parentProducts.meta_title)
            if (parentProducts.meta_description) formData.append('meta_description', parentProducts.meta_description)
            if (parentProducts.category) {
                parentProducts.category.forEach((catId: string, index: number) => {
                    formData.append(`category[${index}]`, catId)
                })
            }

            if (parentProducts.subcategory) {
                parentProducts.subcategory.forEach((subCatId: string, index: number) => {
                    formData.append(`subcategory[${index}]`, subCatId)
                })
            }

            if (parentProducts.subsubcategory) {
                parentProducts.subsubcategory.forEach((subSubCatId: string, index: number) => {
                    formData.append(`subsubcategory[${index}]`, subSubCatId)
                })
            }

            if (imageAltTextChild) {
                formData.append('image_alt_text', imageAltTextChild);
            } else if (parentProducts.image_alt_text) {
                formData.append('image_alt_text', parentProducts.image_alt_text);
            }
            if (Object.values(selectedValues).length > 0) {
                Object.values(selectedValues).forEach((selected: any) => {
                    formData.append('variants[]', selected.value);
                });
            }
                                        ...
                                        <Col xs={12}>
                                            <Form.Group className="mb-3">
                                                ...
                                                <Form.Control
                                                    ...
                                                    value={imageAltTextChild}
                                                    onChange={(e) => setImageAltTextChild(e.target.value)}
                                                    disabled={!featureImageFile}
                                                />
                                                {!featureImageFile && (
            ...
            <Card.Body>
                <Tab.Container defaultActiveKey="general">
                    <Nav variant="tabs" className="mb-3">
                        ...
                        <Nav.Item>
                            <Nav.Link as={Link} to="#" eventKey="seo">
                                <span className="d-block">SEO Features</span>
                            </Nav.Link>
                        </Nav.Item>
                    </Nav>
                            ...
                            <Row className="align-items-center">
                                ...
                                <Col xs={12} lg={6} className="mb-3 mt-3">
                                    <Form.Group className="mb-3 d-flex align-items-center">
                                        <Form.Label htmlFor="currency" className="me-2 mb-0" style={{ minWidth: '80px' }}>
                                            Currency:
                                        </Form.Label>
                                        <FormInput
                                            type="text"
                            ...
                            {/* <Row className="mt-3">
                                <Col xs={12} lg={4} className="mb-4">
                                    <div className="d-flex align-items-center h-100">
                                        <div className="toggle-container me-2">
                                        ...
                                        <div className="info-text">
                                            <p className="mb-0">Keep In Section 14  <i
                                                className="ri-information-line ms-1"
                                                title="You Can See the Name of Section 14 in 'Feature Title' in Content Management"
                                                style={{ cursor: 'help' }}
                                            /></p>
                                        </div>
                                    </div>
                                ...
                                <Col xs={12} lg={4} className="mb-4">
                                    <div className="d-flex align-items-center h-100">
                                        <div className="toggle-container me-2">
                                            <label className="toggle">
                                                <input
                                                    type="checkbox"
                                                    checked={isShopByPet}
                                                    onChange={() => setIsShopByPet(!isShopByPet)}
                                                />
                                                <span className="slider"></span>
                                                <span className="text on">Yes</span>
                                                <span className="text off">No</span>
                                        ...
                                        <div className="info-text">
                                            <p className="mb-0">Keep In Section 6 <i
                                                className="ri-information-line ms-1"
                                                title="You Can See the Name of Section 6 in 'Feature Title' in Content Management"
                                                style={{ cursor: 'help' }}
                                            /></p>
                                        </div>
                                    </div>
                                ...
                                <Col xs={12} lg={4} className="mb-4">
                                    <div className="d-flex align-items-center h-100">
                                        ...
                                        <div className="info-text">
                                            <p className="mb-0">Keep In New Arrival</p>
                                        </div>
                                    </div>
                                </Col>
                                <Col xs={12} lg={4} className="mb-4">
                                    <div className="d-flex align-items-center h-100">
                                        <div className="toggle-container me-2">
                                            <label className="toggle">
                                                <input
                                                    ...
                                                    onChange={() => setIsServiceProduct(!isServiceProduct)}
                                                />
                                                <span className="slider"></span>
                                                <span className="text on">Yes</span>
                                                <span className="text off">No</span>
                                        ...
                                        <div className="info-text">
                                            <p className="mb-0">Is Service Product</p>
                                        </div>
                                    </div>
                                </Col>
                            </Row> */}
