...
import { SERVICES_SETTINGS } from '@/constants/menu'
...
const ServicesSettingsPage: React.FC = () => {
    ...
    return (
        <>
            <PageBreadcrumb title="Services Settings" subName="Settings" />

            <Card>
                <Card.Header className="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 className="header-title mb-0">Services Settings</h4>
                        <p className="text-muted mb-0">Manage all services related configurations</p>
                    </div>
                </Card.Header>

                <Card.Body>
                    <Row>
                        {SERVICES_SETTINGS?.map((setting: any) => (
