...
import { GENERAL_SETTINGS } from '@/constants/menu'
...
const GeneralSettingsPage: React.FC = () => {
    ...
    return (
        <>
            <PageBreadcrumb title="General Settings" subName="Settings" />

            <Card>
                <Card.Header className="d-flex justify-content-between align-items-center">
                    <div>
                        <h4 className="header-title mb-0">General Settings</h4>
                        <p className="text-muted mb-0">Manage all General related configurations</p>
                    </div>
                </Card.Header>

                <Card.Body>
                    <Row>
                        {GENERAL_SETTINGS?.map((setting: any) => (
