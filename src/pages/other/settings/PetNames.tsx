...
const PetNames = () => {
    ...
    const getPetNames = async () => {
        try {
            ...
            if (!response.ok) {
                ...
                throw new Error(errorMessage.message || 'Failed to fetch pet names')
            }
    ...
    const handleAddtags = async (formData: any) => {
        ...
        try {
            ...
            if (!response.ok) {
                const errorMessage = await response.json()
                console.log("message from backed ", errorMessage);
    ...
    return (
        <>
            <PageBreadcrumb title="Pets" subName="Settings"  allowNavigateBack={true} />
            <Card>
                <Card.Header>
                    <div className="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center">
                        <div>
                            <h4 className="header-title">Pets Management</h4>
                            <p className="text-muted mb-0">
                                Add and Manage your all Pets here.
                            </p>
                        </div>
                        <div className="mt-3 mt-lg-0 d-flex flex-column flex-sm-row align-items-start align-items-lg-center gap-2">
                            <Button
                                ...
                                variant="success"
                                onClick={toggleModal}>
                                <i className="bi bi-plus"></i> Add New Pets
                            </Button>
                            {showDeleteButton && (
                                <Button
                                    variant="danger"
