...
const RequestedOrder = () => {
    ...
    const [orders, setOrders] = useState<RequestedOrder[]>([])
    ...
    const fetchOrders = async () => {
        setLoading(true)
        try {
            const response = await fetch(`${BASE_API}/api/checkout/order?isMain=false`, {
                headers: {
    ...
    const handleExportOrders = async () => {
        ...
        try {
            const response = await fetch(
                `${BASE_API}/api/checkout/orders/download-data?isMain=false`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
    ...
    const handleApprovalSubmit = async () => {
        ...
        try {
            const response = await fetch(
                `${BASE_API}/api/checkout/${selectedOrder._id}/approve/request`,
                {
                    method: 'PATCH',
                    headers: {
                        'Content-Type': 'application/json',
            ...
            <Card>
                <Card.Header>
                    <div className="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center">
                        <div className="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center">
                            <div>
                                <h4 className="header-title">Requested Order Management</h4>
