...
const ServiceSubCategory = () => {
    ...
    const toggleEditModal = (subCategory: TableRecord) => {
        ...
        setValue('serviceCategory', subCategory?.serviceCategory?._id)
        toggleModal()
    }
    ...
    const handleAddSubCategory = async (formData: any) => {
        try {
            ...
            const response = await fetch(`${BASE_API}/api/service-subcategories`, {
                method: 'POST',
                headers: {
    ...
    const handleUpdateSubCategory = async (formData: any) => {
        try {
            ...
            const response = await fetch(
                `${BASE_API}/api/service-subcategories/${editingSubCategory?._id}`,
                {
                    method: 'PUT',
                    headers: {
                        Authorization: `Bearer ${token}`,
    ...
    const deleteSelectedSubCategories = async (ids: string[]) => {
        try {
            const response = await fetch(
                `${BASE_API}/api/service-subcategories/bulk-delete`,
                {
                    method: 'DELETE',
                    headers: {
            ...
            <Card>
                <Card.Header>
                    <div className="d-flex flex-column flex-lg-row justify-content-between align-items-lg-center">
                        <div>
                            <h4 className="header-title">Service Sub Categories</h4>
                            <p className="text-muted mb-0">Manage Service Sub Categories</p>
                        </div>
                ...
                <Form onSubmit={handleSubmit(editingSubCategory ? handleUpdateSubCategory : handleAddSubCategory)}>
                    <Modal.Body>
                        <Form.Group className="mb-3">
                            ...
                            <Form.Select {...register('serviceCategory')} required>
